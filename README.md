...
Rather than force a broken pipeline, the smarter call was to find a dataset that was already clean and annotated. The Martian/Lunar Crater Detection Dataset (lincolnzh, Kaggle) provided properly formatted YOLO bounding box annotations across 143 images. YOLOv8s was fine-tuned on this and hit solid metrics.
...
Results
MetricScorePrecision0.674Recall0.603mAP500.617F1 Score0.636Craters detected10,727Lunar tiles processed6,796Diameter range1.1 km — 85.3 kmMedian diameter7.6 km
Show Image
...
Source: Martian/Lunar Crater Detection Dataset — lincolnzh, Kaggle
...
Feb 2026 – Apr 2026lio project using real NASA/ESA planetary imagery.
